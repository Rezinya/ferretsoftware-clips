...
export default function Home() {
  return (
    <div>
      <Title order={2} className="title">Welcome!</Title>
      ...
      <Alert variant="light" title="Did you know?" icon={ <RiQuestionLine /> }>
        ...
        <ul>
          <li>Number of clips with 100+ views: <strong>1719</strong></li>
          <li>Number of clips with 100+ views: <strong>3204</strong></li>
        </ul>
      </Alert>
    </div>
  );
